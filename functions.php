...
function themeConfig($form) {
    ...
    $indexbanner=new Typecho_Widget_Helper_Form_Element_Textarea('indexbanner', NULL, '', _t('首页默认头图'), _t('填写首页默认的头图，一行一个随机显示。若不填写则不显示默认头图。你可以填写随机图片API。最后不要留空行。'));
