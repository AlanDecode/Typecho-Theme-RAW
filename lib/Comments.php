 ...
 * @license GNU General Public License 2.0
 */
class RAW_Widget_Comments_Archive extends Widget_Abstract_Comments
{
     /**
     * 当前页
     *
    ...
    private function threadedCommentsCallback()
	{
        ...
        ?>">
                <div class="comment-header flex flex-direction-column">
                    <?php $this->gravatar(50, ''); ?></a>
                    <span><?php $this->reply('<i class="fa fa-reply"></i> 回复'); ?></span>
                </div>
                <div class="comment-body flex flex-direction-column">
                    <span class="comment-meta"><?php Utils::exportCommentMeta($this);?></span>
                    <div class="comment-content"><?php echo $this->getParent(); echo Utils::parseBiaoQing($this->content); ?></div>
                </div>
            </div>
            </div>
